            ...
            <div className='w-full mt-4'>
                    <div>
                        <div className='flex text-white font-bold'>
                            ...
                            <div className='border-2 bg-[#CB0881] px-3 py-1 text-center w-3/12'>Join Date</div>
                        ...
                        <div className='flex'>
                            ...
                            <div className='border-2  px-3 py-1 text-center w-3/12 flex items-center justify-center'><button className='px-6 py-2 bg-red-700 text-white font-bold rounded-full'>Delete</button></div>
                        </div>
